...
{
    public class ApiControllerTsFt
    {
        private readonly Model model;

        public ApiControllerTsFt(Model model)
        {
            this.model = model;
        }
        ...
        public string GenerateText()
        {
            ...
            return $@"
                ...
                export class {this.model.Name} {{
                    ...
                    controllerRoute: string = 'api/{ this.model.Name.Split(new[] { "Controller" }, StringSplitOptions.None)[0].ToCamelCase() }';
